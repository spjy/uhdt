...
parser.add_argument('--xmins', help="xmins of image", type=float, nargs='+')
parser.add_argument('--xmaxs', help="xmaxs of image", type=float, nargs='+')
parser.add_argument('--ymins', help="ymins of image", type=float, nargs='+')
parser.add_argument('--ymaxs', help="ymaxs of image", type=float, nargs='+')
